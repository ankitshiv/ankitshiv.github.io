...
(function () {
  ...
  class FBUBBLE extends HTMLElement {
    ...
    onCustomWidgetAfterUpdate(changedProperties) {
      ...
      //   make REST call using relative path
      let makeRestCall = function () {
        let url =
          "/comsapdsciampdms.comsappdmslib/platform/service-catalog/api/v1/service-entries?serviceTypeId=com.sap.pdms.InsightProvider&serviceInteractive=true&capability%5B%5D=multi-equipment&uomsystem=metric";
  ...
  customElements.define("com-gmail-cse-ankitshiv-d3forcebubble", FBUBBLE);
})();
